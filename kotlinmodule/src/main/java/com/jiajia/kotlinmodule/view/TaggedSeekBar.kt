...
class TaggedSeekBar @JvmOverloads constructor(
    ...
    private fun initAttr(context: Context, attrs: AttributeSet?) {
        ...
        primaryColor = ta.getColor(R.styleable.TaggedSeekBar_primaryColor, Color.parseColor("#5A90FA"))
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.apply {
            ...
            drawCircle(cx, cy, thumbRadius + thumbStrokeWidth, thumbPaint)
//            drawCircle(cx, cy, thumbRadius, thumbPaint)
            ...
            val tagText = progress.toInt().toString()
